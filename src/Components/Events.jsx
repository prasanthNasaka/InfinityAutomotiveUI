...
const EventForm = () => {
  ...
  const handleQRCodeChange = (e) => {
    ...
    if (file) {
      setEventData({
        ...
        bankDetails: {
          ...eventData.bankDetails,
          Qrpath: file, // Update QR path with the uploaded file
        },
      });
    }
    e.target.value = ""; // Reset input to allow re-upload of the same file
  ...
  const handleEdit = (event) => {
    console.log("Event being edited:", event); // Check the full event object here
    ...
    setEventData({
      ...
      geoLocation: event.gmapLocation || "", // Set geoLocation correctly using gmapLocation
  ...
  const handleUpdate = async (e) => {
    ...
    console.log("Updating event with ID:", editId); // Add this to debug
    ...
    try {
      ...
      // Use a complete URL with ID included
      ...
      // Update the submittedEvents array with the updated event
      setSubmittedEvents(
                              ...
                              <img
                                src={
                                  typeof eventData.bannerImage === "string"
                                    ? eventData.bannerImage // Use the URL
                                    : URL.createObjectURL(eventData.bannerImage) // Use Object URL for file
                                }
                                alt="Uploaded Banner"
                              ...
                              <div className="relative w-full h-full">
                                <img
                                  src={
                                    ...
                                    "string"
                                      ? eventData.bankDetails.Qrpath // Use the URL for QR image
                                      : URL.createObjectURL(
                                          eventData.bankDetails.Qrpath
                                        ) // Use Object URL for file
                                  }
